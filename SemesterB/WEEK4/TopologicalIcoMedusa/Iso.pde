...
//           faces.add(new Polygon(9, 8, 1, 0));
     ...
     void draw() {
       ...
       for(int f = 0; f < faces.size(); f++){
            ...
            beginShape();
            vertex(vertices.get(faces.get(f).a).x * 64, vertices.get(faces.get(f).a).y * 64, vertices.get(faces.get(f).a).z * 64);
            vertex(vertices.get(faces.get(f).b).x * 64, vertices.get(faces.get(f).b).y * 64, vertices.get(faces.get(f).b).z * 64);
            vertex(vertices.get(faces.get(f).c).x * 64, vertices.get(faces.get(f).c).y * 64, vertices.get(faces.get(f).c).z * 64);
            endShape(CLOSE);
